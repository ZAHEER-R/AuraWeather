...
const WeatherAPI = (() => {
  ...
  const SAMPLE_NEWS = [
    { title: 'Heatwave advisories issued across several regions this week', desc: 'Meteorologists urge residents to stay hydrated and avoid peak-hour sun exposure as temperatures climb.', source: 'Aura Digest', time: new Date().toISOString(), image: 'https://images.unsplash.com/photo-1504370806027-ec99f912a0c9?w=400&q=80', url: '#' },
    { title: 'Monsoon systems strengthen over coastal belts', desc: 'Weather services track a developing low-pressure system expected to bring heavy showers and possible flooding.', source: 'Aura Digest', time: new Date().toISOString(), image: 'https://images.unsplash.com/photo-1428908728789-d2de25dbd4e2?w=400&q=80', url: '#' },
    { title: 'Air quality improves in major metros after overnight rain', desc: 'PM2.5 levels dropped sharply following showers, offering brief relief from smog.', source: 'Aura Digest', time: new Date().toISOString(), image: 'https://images.unsplash.com/photo-1446776811953-b23d57bd21aa?w=400&q=80', url: '#' },
    { title: 'Early-season cyclone watch: coastal communities advised to prepare', desc: 'Authorities recommend reviewing evacuation routes and emergency kits ahead of the season.', source: 'Aura Digest', time: new Date().toISOString(), image: 'https://images.unsplash.com/photo-1527482797697-8795b05a13fe?w=400&q=80', url: '#' },
    { title: 'UV index spikes — protect skin and eyes outdoors', desc: 'High UV levels expected during midday hours; sunscreen and shade recommended.', source: 'Aura Digest', time: new Date().toISOString(), image: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=400&q=80', url: '#' }
  ];
